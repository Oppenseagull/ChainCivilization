...
/// <summary>
/// Exploration map panel toggled with M. Soft blue Stardew-style 2D overview with glowing player dot.
/// </summary>
public class MapPanelUI : MonoBehaviour
{
    ...
    void BuildUi()
    {
        ...
        GameObject canvasObject = new GameObject("MapPanelCanvas");
        canvasObject.transform.SetParent(transform, false);

        _canvas = canvasObject.AddComponent<Canvas>();
        _canvas.renderMode = RenderMode.ScreenSpaceOverlay;
        _canvas.sortingOrder = 195;
        ...
        _root = CreateUiObject("MapPanelRoot", canvasObject.transform);
        StretchFull(_root.GetComponent<RectTransform>());

        Image dim = _root.AddComponent<Image>();
        dim.color = new Color(0.03f, 0.08f, 0.14f, 0.55f);

        GameObject panel = CreateUiObject("MapPanel", _root.transform);
        ...
        panelImage.color = new Color(0.1f, 0.18f, 0.28f, 0.96f);
        ...
        CreateTitle(panel.transform, "文明探索地图");
        _mapWidget = ExplorationMapView.Build(panel.transform, 680f, 500f);
        CreateFooter(panel.transform, "M / ESC 关闭");
    }
    ...
    static void CreateTitle(Transform parent, string text)
    {
        ...
        title.color = new Color(0.82f, 0.94f, 1f);
    }
    ...
    static void CreateFooter(Transform parent, string text)
    {
        ...
        footer.color = new Color(0.62f, 0.78f, 0.9f, 0.9f);
    }
